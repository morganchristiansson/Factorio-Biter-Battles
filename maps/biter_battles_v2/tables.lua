...
Public.food_values = {
    ...
    ['military-science-pack'] = { value = 0.009, name = 'military science', color = '105, 105, 105' },
    ['chemical-science-pack'] = { value = 0.012, name = 'chemical science', color = '100, 200, 255' },
    ['production-science-pack'] = { value = 0.04, name = 'production science', color = '150, 25, 255' },
    ['utility-science-pack'] = { value = 0.07, name = 'utility science', color = '210, 210, 60' },
    ['space-science-pack'] = { value = 0.003, name = 'space science', color = '255, 255, 255' },
    ['metallurgic-science-pack'] = { value = 0.08, name = 'metallurgic science', color = '255, 165, 0' },
    ['electromagnetic-science-pack'] = { value = 0.15, name = 'electromagnetic science', color = '255, 192, 203' },
    ['agricultural-science-pack'] = { value = 0.02, name = 'agricultural science', color = '192, 255, 0' },
    ['cryogenic-science-pack'] = { value = 0.1, name = 'cryogenic science', color = '0, 0, 139' },
    ['promethium-science-pack'] = { value = 1.337, name = 'promethium science', color = '40, 20, 40' },
}
